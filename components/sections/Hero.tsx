...
const Hero = () => {
  return (
    <section className="min-h-screen relative overflow-hidden flex items-center">
      ...
      {/* === BACKGROUND: Portrait photo area === */}
      {/* Зурагтай болоход энэ div-г Image болгоно */}
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-12 md:px-16 flex items-center justify-between min-h-screen py-24">
        ...
        >
          ...
          {/* Social icons — зүүн доод хэсэгт, screenshot шиг */}
        ...
        {/* Center spacer — portrait байрлах хэсэг */}
        ...
        >
          ...
          {/* Resume button — баруун доод хэсэгт */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
